...
#define MyAppName "QtPass for Teams"
#define MyAppVersion "1.3.3.1"
#define MyAppPublisher "Thomas Mielke"
#define MyAppURL "https://qtpass.org/"
#define MyAppExeName "qtpass.exe"

; #define QtDir GetEnv('QTDIR')
#define QtDir "C:\Qt\5.15.2\mingw81_64"
#define BuildDir "C:\Users\mielk\Work\build-qtpass-Desktop_Qt_5_15_2_MinGW_64_bit-Release"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{DCE13290-FCBA-4744-BE67-83350CF5EA19}
AppName={#MyAppName}
...
Source: "{#BuildDir}\main\release\qtpass.exe"; DestDir: "{app}"; Flags: ignoreversion
